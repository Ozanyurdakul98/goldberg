...
export default function Kontakt() {
  return (
    ...
    >
        <div class="container flex flex-col mx-auto bg-white dark:bg-zinc-900">
            <div class="w-full draggable">
                <div class="container flex flex-col items-center gap-16 mx-auto mt-10 mb-32">
                    <div class="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                        <div class="flex flex-col items-center gap-3 px-8 py-10 bg-white dark:bg-zinc-800 rounded-3xl shadow-main">
                        <span>

            ...
            >
                <div className="container flex flex-col mx-auto bg-white dark:bg-zinc-900">
                    <div className="w-full draggable">
                        <div className="container flex flex-col items-center gap-16 mx-auto mt-10 mb-10">
                            <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                                <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white dark:bg-zinc-800 rounded-3xl shadow-main">
                                    <span>
                                        <svg
                                            className="w-10 h-10 text-[#C3A433]"
                                    ...
                                    <a
                                        ...
                                        href="mailto: anfrage@goldberg-catering.de"
                                    >
                                ...
                                <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white dark:bg-zinc-800 rounded-3xl shadow-main">
                                    ...
                                    <a
                                        className="text-lg text-center font-bold text-purple-blue-500"
                                        target="_blank"
                                        href="https://maps.app.goo.gl/DUmEw7QKWd88RgHE8"
                                    >
                                        {' '}
                                        Beethovenplatz 1, 61674 Kronberg im
                                        Taunus
                                    </a>
                                </div>
                            </div>

        ...
        <div className="bg-white py-16 dark:bg-transparent">
            <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-6 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl lg:mx-0">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-zinc-400 sm:text-4xl">
                        Unsere hausinternen Leistungen
                    </h2>
                    <p className="mt-6 text-lg leading-8 text-zinc-500 dark:text-zinc-400">
                        Wir sind Ihr Ansprechpartner für Veranstaltungen bei
                        Ihnen zu Hause oder zu einem geschäftlichen Anlass bei
                        uns im Stammhaus. Selbstverständlich liefern wir Ihnen
                        auch Ihre Wunschgerichte direkt zu Ihnen nach Hause für
                        ein Abendessen mit der Familie oder mit Freunden.
                    </p>
                </div>
                {/* cards */}
                <ul
                    ...
                    {food.map((person) => (
                        ...
                        >
                            ...
                            <div className="max-w-xs max-lg:max-w-[14rem] absolute max-lg:bottom-0 max-lg:bg-white/90 max-sm:max-w-xs max-sm:bg-white max-lg:rounded-bl-xl bottom-10 bg-white border w-full px-2 rounded-r-xl">
                                <h3 className="mt-5 text-lg max-lg:text-base font-semibold leading-8 text-gray-900">
                                    {person.name}
                                </h3>
                                <p className="text-base max-lg:text-base mb-1 font-extralight leading-7 text-gray-600">
                                    {person.role}
                                </p>
                            </div>
                        </li>
...
const features = [
    ...
    },
    {
        ...
        description:
            ' Bei Goldberg Catering & Events bieten wir mehr als nur Speisen und Getränke – wir schaffen kulinarische Erlebnisse, die die Sinne begeistern.',
    },
    {
        name: 'Expertise.',
        description:
            ' Bis zu 600 Gäste in der historischen Atmosphäre von Kronberg verwöhnen wir mit exquisiten Speisen und Getränken.',
    },
]
                    ...
                    <div className="lg:pr-8 lg:pt-4">
                        <div className="lg:max-w-lg">
                            ...
                            <p className="mt-6 text-lg leading-8">
                                Tauchen Sie ein in die Welt der erstklassigen
                                Catering-Services von Goldberg Catering &
                                Events, exklusiver Partner der renommierten
                                Kronberg Academy.
                            </p>
            ...
            <Container className="mt-40">
                <div className="max-w-2xl mb-7">
                    ...
                    <p className="mt-6 text-base font-medium lg:text-[17px] text-zinc-500 dark:text-zinc-400">
                        Wir setzen auf unvergleichliche Qualität, indem wir
                        jedes Gericht und jede Feinkost in unseren eigenen
                        Küchen von Hand zubereiten. Von der Auswahl der
                        frischesten Zutaten bis zur kunstvollen Präsentation
                        garantieren wir, dass jedes kulinarische Erlebnis bei
                        uns ein Meisterwerk der Handwerkskunst ist. Vertrauen
                        Sie auf unsere Liebe zum Detail, die in jedem Bissen
                        spürbar ist – Willkommen bei Goldberg Catering & Events.
                    </p>
                            ...
                            <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                                ...
                                <div>
                                    <div className="text-base leading-7 text-gray-700 dark:text-zinc-400 lg:max-w-lg">
                                        <p className="text-base font-semibold leading-7 text-[#C3A433]">
                                            Unsere Werte
                                        </p>
                                        <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-zinc-400 sm:text-4xl">
                                            Leidenschaft für Catering,
                                            Perfektion für Events
                                        </h1>
                                        <div className="max-w-xl">
                                            <p className="mt-6">
                                                Willkommen bei Goldberg Catering
                                                & Events, wo aus meiner
                                                Überzeugung, dass mit Hingabe
                                                und harter Arbeit alles möglich
                                                ist, eine wegweisende
                                                Erfolgsgeschichte entstanden
                                                ist.
                                            </p>
                                            <p className="mt-8">
                                                Unser Ursprung in Kelsterbach
                                                führte uns zu einer führenden
                                                Position in den Bereichen
                                                Airline Catering, Airport
                                                Handling, Personalvermittlung
                                                und exklusivem Eventcatering.
                                                Unser Credo lautet dabei stets:
                                                »Setzen Sie Standards, folgen
                                                Sie ihnen nicht.« Höhepunkte
                                                unserer Reise umfassen die
                                                Partnerschaft mit der
                                                renommierten Kronberg Academy
                                                Stiftung und die Ehre, die
                                                VIP-Bereiche im Stadion von
                                                Eintracht Frankfurt zu betreuen.
                                                Dies repräsentiert die
                                                einzigartige Verbindung von
                                                Geschichte und Exzellenz.
                                            </p>
                                            <p className="mt-8">
                                                Unser Erfolg gründet sich auf
                                                einem herausragenden Team, das
                                                gemeinsam mit mir nicht nur eine
                                                Vision, sondern die feste
                                                Überzeugung teilt, dass Großes
                                                erreicht werden kann. Willkommen
                                                bei Goldberg Catering & Events,
                                                wo Leidenschaft und
                                                Professionalität in jedem
                                                Catering-Erlebnis verschmelzen.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-10 flex">
                                        <a
                                            href="/kontakt"
                                            className="text-base font-semibold leading-7 text-[#C3A433]"
                                        >

    ...
    <footer className="">
      <ContainerOuter>
        ...
        <nav className="-mb-6 columns-2 flex justify-center space-x-12" aria-label="Footer">
          {navigation.main.map((item) => (
            <div key={item.name} className="pb-6">
              <a href={item.href} className="text-sm leading-6 text-gray-600 hover:text-gray-900 hover:dark:text-gray-700">
                {item.name}
              </a>
            </div>
          ))}
        ...
        <p className="mt-4 flex gap-2 justify-center flex-row text-center text-xs leading-5 text-zinc-400 dark:text-zinc-500">
              ...
              <a href = "mailto: anfrage@goldberg-catering.de">anfrage@goldberg-catering.de</a>

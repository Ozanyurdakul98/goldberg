                        ...
                        <nav className="mt-6">
                            <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                                ...
                                <MobileNavItem
                                    ...
                                    target="_blank"
                                >
                                    <InstagramIcon className="relative z-0 h-4 w-4" />
                                </MobileNavItem>
                                <MobileNavItem
                                    href="https://www.facebook.com/goldberg.deutschland/"
                                    target="_blank"
                                >
                                    <FacebookIcon className="relative z-0 h-4 w-4" />
                                </MobileNavItem>
                            </ul>
                        </nav>
                    </Popover.Panel>
...
function Avatar({ large = false, className, ...props }) {
    return (
        <Link
            ...
            className={clsx(
                className,
                large ? 'max-sm:h-20 max-sm:w-20 h-24 w-24' : 'h-9 w-9',
                'relative pointer-events-auto rounded-full bg-zinc-50 dark:bg-zinc-800'
            )}
            {...props}
        >
            <Image
                ...
                alt=""
                className={clsx(
                    'absolute top-[46%] left-1/2 transform -translate-x-1/2 -translate-y-1/2',
                    large ? 'max-sm:h-16 max-sm:w-16 h-20 w-20' : 'h-9 w-9'
                )}
            />
        </Link>
    )
...
export function Header() {
    ...
    return (
        <>
            ...
            >
                <div ref={headerRef} className="relative flex z-10 h-16 pt-6">
                    {/* avatar */}
                    <div className="w-full absolute max-lg:-left-20 -left-3 top-5">
                        ...
                        <Avatar
                            large
                            className="block h-16 w-24 origin-left"
                            style={{
